...
# Reverted to the original directory name as requested
plot_output_directory = "ingarch_order_differences_boxplots"
...
if os.path.exists(path_to_rds_no_covariates):
    create_aic_difference_boxplots(filepath=path_to_rds_no_covariates,
                                   ...
                                   output_dir=plot_output_directory, # Using the reverted directory name
